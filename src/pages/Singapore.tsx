...
const activities = [
  ...
  { title: "Night Safari Singapore", price: 4470, image: singaporeNightSafari, slug: "singapore/singapore/night-safari" },
  { title: "Sentosa 4D Adventureland", price: 2060, image: singaporeSentosa4d, slug: "singapore/sentosa-4d-2rides" },
  { title: "Sentosa Cable Ride", price: 2180, image: singaporeCableCar, slug: "singapore/singapore/sentosa-cable-car" },
  { title: "Sentosa Wings of Time with Transfers", price: 2656.5, image: singaporeWingsTime, slug: "singapore/singapore/sentosa-wings-time" },
  { title: "Sentosa Sky Helix", price: 1811.25, image: singaporeSkyHelix, slug: "singapore/singapore/sentosa-sky-helix" },
  { title: "Singapore River Cruise", price: 2173.5, image: singaporeRiverCruise, slug: "singapore/singapore/river-cruise" },
  { title: "Gardens by the Bay", price: 2660, image: singaporeGardensBay, slug: "singapore/singapore/gardens-by-the-bay" },
  { title: "Adventure Cove Water Park", price: 2656.5, image: singaporeAdventureCove, slug: "singapore/singapore/adventure-cove" },
  { title: "Singapore Flyer Ticket", price: 3381, image: singaporeFlyer, slug: "singapore/singapore/flyer" },
  { title: "Singapore River Safari", price: 4468, image: singaporeRiverSafari, slug: "singapore/singapore/river-safari" },
  { title: "Universal Studios Weekday Ticket", price: 6762, image: singaporeUniversalStudios, slug: "singapore/singapore/universal-studios-weekday" },
  { title: "Universal Studios Weekend Ticket", price: 7872.9, image: singaporeUniversalStudios, slug: "singapore/singapore/universal-studios-weekend" },
  { title: "Singapore Zoo + Tram Ride", price: 3743.25, image: singaporeZoo, slug: "singapore/singapore/zoo" },
  { title: "Rainforest Wild Asia with Transfer", price: 3441.375, image: singaporeZoo, slug: "singapore/singapore/rainforest-wild-asia" },
  { title: "Big Bus Singapore - Discover Ticket", price: 4709.25, image: singaporeBigBus, slug: "singapore/singapore/big-bus-discover" },
  { title: "Big Bus Singapore Night City Tour", price: 4709.25, image: singaporeBigBus, slug: "singapore/singapore/big-bus-night" },
];
    ...
    <div className="min-h-screen bg-background">
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <QuickBookWidget
          ...
          items={[
            { title: "Universal Studios Weekday", price: 6762, image: singaporeUniversalStudios, slug: "/singapore/universal-studios-weekday", rating: 4.9, badge: "Bestseller" },
            { title: "Gardens by the Bay", price: 2660, image: singaporeGardensBay, slug: "/singapore/gardens-by-the-bay", rating: 4.8, badge: "Iconic" },
            { title: "Night Safari Singapore", price: 4470, image: singaporeNightSafari, slug: "/singapore/night-safari", rating: 4.7 },
            { title: "Singapore City Tour", price: 1815, image: singaporeCityTour, slug: "/singapore/city-tour", rating: 4.6 },
            { title: "Sentosa Cable Ride", price: 2180, image: singaporeCableCar, slug: "/singapore/sentosa-cable-car", rating: 4.5 },
