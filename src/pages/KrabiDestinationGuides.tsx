...
import {
  ...
  KrabiBlogCategory,
  krabiBlogs,
  getKrabiBlogsByCategory,
} from "@/data/krabiDestinationGuides";

const SEO_TITLE = "Krabi Destination Guides — Itineraries, Activities & Transfers";
const SEO_DESC =
  "Krabi travel blogs across 6 categories — itineraries, activities, comparisons, Indian tips, micro guides and transfers.";

const KrabiDestinationGuides = () => {
  const [active, setActive] = useState<KrabiBlogCategory | "all">("all");
  ...
  const grouped = useMemo(
    () =>
      KRABI_CATEGORIES.map((c) => ({
        ...c,
        blogs: getKrabiBlogsByCategory(c.key),
      })),
    [],
  );
  ...
  return (
    <div className="min-h-screen flex flex-col">
      <CanonicalUrl path="/thailand/krabi/destination-guides" />
      <Header />
        ...
        <div className="container px-4 py-6">
          <Breadcrumb className="mb-6">
            <BreadcrumbList>
              ...
              <BreadcrumbItem>
                <BreadcrumbLink asChild>
                  <Link to="/thailand/krabi">Krabi</Link>
                </BreadcrumbLink>
              </BreadcrumbItem>
              <BreadcrumbSeparator />
              <BreadcrumbItem>
          ...
          <div className="text-center mb-10">
            <h1 className="text-3xl md:text-5xl font-bold text-foreground mb-3">
              Krabi Destination Guides
            </h1>
            <p className="text-muted-foreground text-base md:text-lg max-w-2xl mx-auto">
              Itineraries, island tours, Phi Phi trips, transfer tips and Indian-traveler
              guides — everything you need before booking your Krabi trip.
            </p>
          </div>
          ...
          <div className="flex flex-wrap gap-2 md:gap-3 mb-10 justify-center">
            ...
            >
              All ({krabiBlogs.length})
            </Button>
            {KRABI_CATEGORIES.map((c) => {
              const count = getKrabiBlogsByCategory(c.key).length;
              return (
                <Button
                  key={c.key}
...
export default KrabiDestinationGuides;
