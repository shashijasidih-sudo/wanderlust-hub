...
const QuickPay = () => {
  ...
  const handlePayment = async () => {
    ...
    if (amountNum > 500000) {
      toast.error("Maximum amount is ₹5,00,000");
      return;
    }
    if (!name.trim()) {
        ...
        <div className="max-w-lg mx-auto">
          <div className="text-center mb-8">
            ...
            <p className="text-muted-foreground">
              Make a secure payment directly via Razorpay
            </p>
          </div>
          ...
          <Card>
            <CardContent className="p-6 space-y-5">
              ...
              <div className="space-y-2">
                ...
                {amount && parseFloat(amount) >= 1 && (
                  <p className="text-sm text-muted-foreground">
                    You will pay: ₹{parseFloat(amount).toLocaleString("en-IN", { minimumFractionDigits: 2 })}
                  </p>
                )}
              </div>
              ...
              <div className="space-y-2">
                ...
                <Input
                  id="description"
                  placeholder="e.g. Tour booking, Transfer payment"
                  value={description}
              ...
              <Button
                ...
                disabled={isProcessing || !amount || !name || !email || !phone}
              >
