...
import {
  ...
  PhuketBlogCategory,
  phuketBlogs,
  getPhuketBlogsByCategory,
} from "@/data/phuketDestinationGuides";

const SEO_TITLE = "Phuket Destination Guides — Activities, Cost & Itineraries";
const SEO_DESC =
  "Phuket travel blogs across 6 categories — activities, comparisons, cost, itineraries, Indian tips and transfers.";
  ...
  const grouped = useMemo(
    () =>
      PHUKET_CATEGORIES.map((c) => ({
        ...c,
        blogs: getPhuketBlogsByCategory(c.key),
      })),
    [],
  );
        ...
        <div className="container px-4 py-6">
          ...
          <div className="text-center mb-10">
            ...
            <p className="text-muted-foreground text-base md:text-lg max-w-2xl mx-auto">
              Activity reviews, comparisons, prices, itineraries and transfer tips —
              everything you need before booking your Phuket trip.
            </p>
          </div>
