...
const CustomerInformation = () => {
  ...
  const handleSubmit = async () => {
    ...
    // Store customer info in sessionStorage for the next step
          ...
          <CardContent className="p-6 md:p-8">
            ...
            <div className="text-center mb-6">
              <p className="text-muted-foreground">
                Your booking will be submitted once you go to payment. You can choose your payment method in the next step.
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
              ...
              <div className="lg:col-span-2">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <div>
                    <Label className="text-primary font-semibold">
                      Customer Contact No.<span className="text-destructive">*</span>
                    </Label>
                ...
                <div className="flex items-start gap-2 mt-6">
                  ...
                  <label htmlFor="terms" className="text-sm leading-relaxed">
                    I acknowledge and agree to abide by all cancellation and refund policies of Pattaya City Tour Company, as outlined in their{" "}
