...
import heroImg from "@/assets/phuket-night-market-1.webp";
...
const BlogPhuketCityTourGuide = () => (
  <BlogArticleLayout
    ...
    relatedLinks={[
      ...
      internalLinks={getPhuketInternalLinks("/thailand/phuket/destination-guides/activity/phuket-city-tour-guide")}
  />
);
