...
const activityCards = [
  { title: "Night Safari Tickets Only", location: "Mandai", image: nightSafari, slug: "/night-safari-tickets" },
...
const BlogNightSafariSingapore = () => {
  ...
  <BlogArticleLayout
    ...
    sections={[
      ...
      { type: "cta", content: "Book your Singapore Night Safari tickets now at the best price!", link: "/night-safari-tickets", linkText: "🦁 Book Night Safari Tickets" },
    ]}
  >
    <ActivityCards />
  </BlogArticleLayout>
