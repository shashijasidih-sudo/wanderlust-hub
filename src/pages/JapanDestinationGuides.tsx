...
import {
  ...
  JapanBlogCategory,
  japanBlogs,
  getJapanBlogsByCategory,
} from "@/data/japanDestinationGuides";

const SEO_TITLE = "Japan Smart Guides — Mount Fuji, Tokyo & Kyoto Activities";
const SEO_DESC =
  "Japan travel blogs — Mount Fuji day tours from Tokyo, Tokyo city tour guide and Kyoto temple itineraries for 2026.";

const JapanDestinationGuides = () => {
  const [active, setActive] = useState<JapanBlogCategory | "all">("all");
  ...
  const grouped = useMemo(
    () =>
      JAPAN_CATEGORIES.map((c) => ({
        ...c,
        blogs: getJapanBlogsByCategory(c.key),
      })),
    [],
  );
        ...
        <div className="container px-4 py-6">
          <Breadcrumb className="mb-6">
            <BreadcrumbList>
              ...
              <BreadcrumbSeparator />
              <BreadcrumbItem>
                <BreadcrumbPage>Japan Destination Guides</BreadcrumbPage>
              </BreadcrumbItem>
            </BreadcrumbList>
          </Breadcrumb>
          ...
          <div className="text-center mb-10">
            ...
            <p className="text-muted-foreground text-base md:text-lg max-w-2xl mx-auto">
              Mount Fuji day tours, Tokyo city experiences and Kyoto temple guides —
              everything you need before booking your Japan trip.
            </p>
          </div>
          ...
          <div className="flex flex-wrap gap-2 md:gap-3 mb-10 justify-center">
            ...
            >
              All ({japanBlogs.length})
            </Button>
            {JAPAN_CATEGORIES.map((c) => {
              const count = getJapanBlogsByCategory(c.key).length;
              return (
                <Button
                  key={c.key}
...
export default JapanDestinationGuides;
