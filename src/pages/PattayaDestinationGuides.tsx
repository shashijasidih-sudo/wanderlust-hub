...
import {
  ...
  PattayaBlogCategory,
  pattayaBlogs,
  getPattayaBlogsByCategory,
} from "@/data/pattayaDestinationGuides";

const SEO_TITLE = "Pattaya Destination Guides — Activities, Cost & Itineraries";
const SEO_DESC =
  "Pattaya travel blogs across 7 categories — activities, cost, comparisons, itineraries, Indian tips, micro guides and transfers.";

const PattayaDestinationGuides = () => {
  const [active, setActive] = useState<PattayaBlogCategory | "all">("all");
  ...
  const grouped = useMemo(
    () =>
      PATTAYA_CATEGORIES.map((c) => ({
        ...c,
        blogs: getPattayaBlogsByCategory(c.key),
      })),
    [],
  );
  ...
  return (
    <div className="min-h-screen flex flex-col">
      <CanonicalUrl path="/thailand/pattaya/destination-guides/" />
      <Header />
        ...
        <div className="container px-4 py-6">
          <Breadcrumb className="mb-6">
            <BreadcrumbList>
              ...
              <BreadcrumbItem>
                <BreadcrumbLink asChild>
                  <Link to="/thailand/pattaya/">Pattaya</Link>
                </BreadcrumbLink>
              </BreadcrumbItem>
              <BreadcrumbSeparator />
              <BreadcrumbItem>
          ...
          <div className="text-center mb-10">
            <h1 className="text-3xl md:text-5xl font-bold text-foreground mb-3">
              Pattaya Destination Guides
            </h1>
            <p className="text-muted-foreground text-base md:text-lg max-w-2xl mx-auto">
              Coral Island, cabaret shows, costs, itineraries, comparisons and transfer
              tips — everything you need before booking your Pattaya trip.
            </p>
          </div>
          ...
          <div className="flex flex-wrap gap-2 md:gap-3 mb-10 justify-center">
            ...
            >
              All ({pattayaBlogs.length})
            </Button>
            {PATTAYA_CATEGORIES.map((c) => {
              const count = getPattayaBlogsByCategory(c.key).length;
              return (
                <Button
                  key={c.key}
...
export default PattayaDestinationGuides;
