...
const transfers = [
  ...
  { id: 6, title: "Pattaya + 2 Temple Tour to BKK Airport", subtitle: "Temple Tour then Transfer to BKK Airport", price: 6700, priceLabel: "From", image: "https://images.unsplash.com/photo-1563492065567-7a0b2e7d1a3e?w=800&auto=format&fit=crop", rating: 4.9, reviews: 189, duration: "Tour + 1.5 Hrs", capacity: "Sedan / SUV / Van", slug: "/pattaya/temple-tour-bkk-airport", type: "citytour", category: "citytour", vehicles: ["Sedan (3 Pax)", "SUV (4 Pax)", "Van (10 Pax)"] },
