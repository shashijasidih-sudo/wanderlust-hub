...
import { Search, SlidersHorizontal, Grid3x3, List, Star, MapPin, Clock, Calendar, ChevronDown } from "lucide-react";
            ...
            <CardContent className="p-6">
              <div className="flex flex-col md:flex-row gap-4">
                ...
                >
                  ...
                  Filters
                  {(selectedCategory !== "all" || selectedDuration !== "all" || priceRange[0] > 0) && (
              ...
              <DropdownMenu>
                <DropdownMenuTrigger asChild>
                  <Button variant="outline" className="min-w-[180px] justify-between">
                    Sort: {sortBy === "relevant" ? "Most Relevant" : sortBy === "price-asc" ? "Price: Low to High" : sortBy === "price-desc" ? "Price: High to Low" : "Highest Rated"}
