...
const blogArticles: BlogArticle[] = [
  { id: -6, title: "Bollywood to Hollywood: 15 Famous Movies Filmed in Thailand", description: "Discover famous Bollywood and Hollywood movies filmed in Thailand, from Kaho Naa Pyaar Hai and The Beach to James Bond — plus the real locations and tours to visit them.", category: "Thailand Travel Guide", image: moviesThailandHero, author: "Yellodae Travel Expert", date: "Aug 16, 2026", readTime: "15 min read", slug: "/thailand/phuket/destination-guides/activity/movies-filmed-in-thailand/", city: "multi-city" },
