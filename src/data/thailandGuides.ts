import moviesThailandHero from "@/assets/movies-thailand-hero.webp";
...
export const thailandGuides: ThailandGuide[] = [
  { id: -6, title: "Bollywood to Hollywood: 15 Famous Movies Filmed in Thailand", description: "Famous Bollywood and Hollywood movies filmed in Thailand and the real locations you can visit.", category: "Thailand Travel Guide", image: moviesThailandHero, author: "Yellodae Travel Expert", date: "Aug 16, 2026", readTime: "15 min read", slug: "/thailand/phuket/destination-guides/activity/movies-filmed-in-thailand/" },
  ...
  { id: 4, title: "Island Hopping Guide: Phi Phi & Beyond", description: "Plan the perfect island-hopping adventure through Thailand's archipelagos.", category: "Beach Adventures", image: phiPhiImg, author: "Island Explorer", date: "Nov 18, 2024", readTime: "9 min read", slug: "/thailand/phuket/full-day-phi-phi-island-tour-with-transfer/" },
  ...
  { id: 6, title: "Ethical Elephant Sanctuaries in Thailand", description: "A guide to responsible elephant tourism and the best sanctuaries.", category: "Wildlife", image: elephantImg, author: "Wildlife Expert", date: "Nov 12, 2024", readTime: "11 min read", slug: "/thailand/phuket/elephant-safari/" },
  { id: 7, title: "Krabi Rock Climbing: A Beginner's Guide", description: "Rock climbing at Railay Beach and Ton Sai in Krabi.", category: "Beach Adventures", image: jamesBondImg, author: "Adventure Guide", date: "Nov 10, 2024", readTime: "8 min read", slug: "/thailand/phuket/james-bond-island-speed-boat-tour-with-transfer/" },
  ...
  { id: 9, title: "Ayutthaya Day Trip: UNESCO Heritage Sites", description: "Plan your perfect day trip to the ancient capital of Ayutthaya.", category: "Cultural Sites", image: tigerImg, author: "History Buff", date: "Nov 5, 2024", readTime: "10 min read", slug: "/thailand/bangkok/ayutthaya-day-tour-from-bangkok/" },
  { id: 10, title: "Phuket's Hidden Gems: Secret Beaches", description: "Escape the crowds and discover Phuket's lesser-known beaches.", category: "Beach Adventures", image: phiPhiImg, author: "Local Guide", date: "Nov 2, 2024", readTime: "7 min read", slug: "/thailand/phuket/" },
  { id: 11, title: "Traditional Thai Massage: Complete Guide", description: "Everything about experiencing authentic Thai massage therapy.", category: "Cultural Sites", image: massageImg, author: "Wellness Expert", date: "Oct 30, 2024", readTime: "9 min read", slug: "/thailand/bangkok/thai-massage-spa-deals-bangkok/" },
