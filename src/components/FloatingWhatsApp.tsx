  ...
  return (
    <div className="fixed bottom-6 right-6 z-50 flex flex-col items-end gap-3">
      ...
      <button
        ...
        className={`bg-[#25D366] hover:bg-[#20BD5A] text-white flex items-center justify-center shadow-lg transition-all hover:scale-110 ${
          open
            ? "p-3 sm:p-4 rounded-full"
            : "p-3 sm:px-4 sm:py-3 rounded-full sm:gap-2"
        }`}
