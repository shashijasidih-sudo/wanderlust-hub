/**
 * Renders the "Tour Itinerary" block for Koh Samui activity pages,
 * driven by the verbatim content in src/data/kohSamuiSheetContent.ts.
 */
...
const KohSamuiTourItinerary = ({ tourKey }: Props) => {
  const content = kohSamuiSheetContent[tourKey];
...
export default KohSamuiTourItinerary;
