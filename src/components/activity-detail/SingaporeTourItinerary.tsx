/**
 * Renders the "Tour Itinerary" block for Singapore activity pages,
 * driven by the verbatim content in src/data/singaporeSheetContent.ts.
 */
...
const SingaporeTourItinerary = ({ tourKey }: Props) => {
  const content = singaporeSheetContent[tourKey];
...
export default SingaporeTourItinerary;
