/**
 * Renders the "Tour Itinerary" block for Krabi activity pages,
 * driven by the verbatim content in src/data/krabiSheetContent.ts.
 */
...
const KrabiTourItinerary = ({ tourKey }: Props) => {
  const content = krabiSheetContent[tourKey];
...
export default KrabiTourItinerary;
