/**
 * Renders the "Tour Itinerary" block for Chiang Mai activity pages,
 * driven by the verbatim content in src/data/chiangMaiSheetContent.ts.
 */
...
const ChiangMaiTourItinerary = ({ tourKey }: Props) => {
  const content = chiangMaiSheetContent[tourKey];
...
export default ChiangMaiTourItinerary;
