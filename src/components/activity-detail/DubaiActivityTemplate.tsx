            ...
            <div className="overflow-x-auto">
              <table className="w-full text-[10px] sm:text-xs md:text-sm border border-border rounded-lg overflow-hidden">
                ...
                <tbody>
                  ...
                  <tr className="border-t border-border"><td className="p-2 break-words">Careem / taxi rides</td><td className="p-2 text-right break-words">₹2,000</td></tr>
                  <tr className="border-t border-border"><td className="p-2 break-words">Shopping & souvenirs</td><td className="p-2 text-right break-words">₹3,000</td></tr>
                  <tr className="border-t border-border bg-primary/5 font-semibold"><td className="p-2 break-words">Add-on budget</td><td className="p-2 text-right break-words">≈ ₹8,500</td></tr>
                </tbody>
              </table>
            </div>
          </Section>
