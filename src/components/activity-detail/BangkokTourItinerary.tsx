/**
 * Renders the "Tour Itinerary" block for Bangkok activity pages,
 * driven by the verbatim content in src/data/bangkokSheetContent.ts.
 */
...
const BangkokTourItinerary = ({ tourKey }: Props) => {
  const content = bangkokSheetContent[tourKey];
...
export default BangkokTourItinerary;
